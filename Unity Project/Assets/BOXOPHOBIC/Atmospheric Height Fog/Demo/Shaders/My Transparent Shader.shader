	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 WorldPosition2_g1020 = WorldPosition;
				float temp_output_7_0_g1025 = AHF_FogDistanceStart;
				float temp_output_155_0_g1020 = saturate( ( ( distance( WorldPosition2_g1020 , _WorldSpaceCameraPos ) - temp_output_7_0_g1025 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1025 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch467_g1020 = temp_output_155_0_g1020;
				#else
				float staticSwitch467_g1020 = ( 1.0 - pow( ( 1.0 - abs( temp_output_155_0_g1020 ) ) , AHF_FogDistanceFalloff ) );
				#endif
				half FogDistanceMask12_g1020 = staticSwitch467_g1020;
				float3 lerpResult258_g1020 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( ( FogDistanceMask12_g1020 * FogDistanceMask12_g1020 * FogDistanceMask12_g1020 ) * AHF_FogColorDuo ));
				float3 normalizeResult318_g1020 = normalize( ( WorldPosition2_g1020 - _WorldSpaceCameraPos ) );
				float dotResult145_g1020 = dot( normalizeResult318_g1020 , AHF_DirectionalDir );
				float4 ScreenPos3_g1027 = screenPos;
				float2 UV13_g1027 = ( ( (ScreenPos3_g1027).xy / (ScreenPos3_g1027).z ) * (_ScreenParams).xy );
				float3 Magic14_g1027 = float3(0.06711056,0.00583715,52.98292);
				float dotResult16_g1027 = dot( UV13_g1027 , (Magic14_g1027).xy );
				float lerpResult494_g1020 = lerp( 0.0 , frac( ( frac( dotResult16_g1027 ) * (Magic14_g1027).z ) ) , ( AHF_JitterIntensity * 0.1 ));
				half Jitter502_g1020 = lerpResult494_g1020;
				float temp_output_140_0_g1020 = ( saturate( (( dotResult145_g1020 + Jitter502_g1020 )*0.5 + 0.5) ) * AHF_DirectionalIntensity );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch470_g1020 = temp_output_140_0_g1020;
				#else
				float staticSwitch470_g1020 = pow( abs( temp_output_140_0_g1020 ) , AHF_DirectionalFalloff );
				#endif
				float DirectionalMask30_g1020 = staticSwitch470_g1020;
				float3 lerpResult40_g1020 = lerp( lerpResult258_g1020 , (AHF_DirectionalColor).rgb , DirectionalMask30_g1020);
				#ifdef AHF_DISABLE_DIRECTIONAL
				float3 staticSwitch442_g1020 = lerpResult258_g1020;
				#else
				float3 staticSwitch442_g1020 = lerpResult40_g1020;
				#endif
				half3 Input_Color6_g1021 = staticSwitch442_g1020;
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g1021 = Input_Color6_g1021;
				#else
				float3 staticSwitch1_g1021 = ( Input_Color6_g1021 * ( ( Input_Color6_g1021 * ( ( Input_Color6_g1021 * 0.305306 ) + 0.6821711 ) ) + 0.01252288 ) );
				#endif
				half3 Final_Color462_g1020 = staticSwitch1_g1021;
				half3 AHF_FogAxisOption181_g1020 = AHF_FogAxisOption;
				float3 break159_g1020 = ( WorldPosition2_g1020 * AHF_FogAxisOption181_g1020 );
				float temp_output_7_0_g1022 = AHF_FogHeightEnd;
				float temp_output_167_0_g1020 = saturate( ( ( ( break159_g1020.x + break159_g1020.y + break159_g1020.z ) - temp_output_7_0_g1022 ) / ( AHF_FogHeightStart - temp_output_7_0_g1022 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch468_g1020 = temp_output_167_0_g1020;
				#else
				float staticSwitch468_g1020 = pow( abs( temp_output_167_0_g1020 ) , AHF_FogHeightFalloff );
				#endif
				half FogHeightMask16_g1020 = staticSwitch468_g1020;
				float lerpResult328_g1020 = lerp( ( FogDistanceMask12_g1020 * FogHeightMask16_g1020 ) , saturate( ( FogDistanceMask12_g1020 + FogHeightMask16_g1020 ) ) , AHF_FogLayersMode);
				float mulTime204_g1020 = _TimeParameters.x * 2.0;
				float3 temp_output_561_0_g1020 = ( ( ( WorldPosition2_g1020 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g1020 ) ) * 0.05 );
				float temp_output_7_0_g1026 = AHF_NoiseMin;
				float temp_output_7_0_g1024 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g1020 = saturate( ( ( distance( WorldPosition2_g1020 , _WorldSpaceCameraPos ) - temp_output_7_0_g1024 ) / ( 0.0 - temp_output_7_0_g1024 ) ) );
				float lerpResult198_g1020 = lerp( 1.0 , saturate( ( ( tex3D( AHF_NoiseTexture, temp_output_561_0_g1020 ).r - temp_output_7_0_g1026 ) / ( AHF_NoiseMax - temp_output_7_0_g1026 ) ) ) , ( NoiseDistanceMask7_g1020 * AHF_NoiseIntensity ));
				half NoiseSimplex3D24_g1020 = lerpResult198_g1020;
				#ifdef AHF_DISABLE_NOISE3D
				float staticSwitch42_g1020 = lerpResult328_g1020;
				#else
				float staticSwitch42_g1020 = ( lerpResult328_g1020 * NoiseSimplex3D24_g1020 );
				#endif
				float temp_output_454_0_g1020 = ( staticSwitch42_g1020 * AHF_FogIntensity );
				half Final_Alpha463_g1020 = temp_output_454_0_g1020;
				float4 appendResult114_g1020 = (float4(Final_Color462_g1020 , Final_Alpha463_g1020));
				float4 appendResult457_g1020 = (float4(WorldPosition2_g1020 , 1.0));
				#ifdef AHF_DEBUG_WORLDPOS
				float4 staticSwitch456_g1020 = appendResult457_g1020;
				#else
				float4 staticSwitch456_g1020 = appendResult114_g1020;
				#endif
				float3 temp_output_95_86_g1019 = (staticSwitch456_g1020).xyz;
				float temp_output_95_87_g1019 = (staticSwitch456_g1020).w;
				float3 lerpResult82_g1019 = lerp( saturate( ( _Color * fetchOpaqueVal22 ) ).rgb , temp_output_95_86_g1019 , temp_output_95_87_g1019);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult82_g1019;
				float Alpha = temp_output_95_87_g1019;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 WorldPosition2_g1020 = ase_worldPos;
				float temp_output_7_0_g1025 = AHF_FogDistanceStart;
				float temp_output_155_0_g1020 = saturate( ( ( distance( WorldPosition2_g1020 , _WorldSpaceCameraPos ) - temp_output_7_0_g1025 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1025 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch467_g1020 = temp_output_155_0_g1020;
				...
				surfaceDescription.Alpha = temp_output_95_87_g1019;
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.Vector3Node;30;-1280,1664;Half;False;Property;_NoiseSpeed;Noise Speed;37;0;Create;True;0;0;0;False;0;False;0.5,0.5,0;0.5,0.5,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1280,1440;Half;False;Property;_NoiseScale;Noise Scale;36;0;Create;True;0;0;0;False;0;False;6;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;0,1024;Inherit;False;Property;_NoiseIntensity;Noise Intensity;35;0;Create;True;0;0;0;False;1;Space(10);False;0;0.103;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;0,1728;Inherit;False;Property;_VertexIntensity;Vertex Intensity;38;0;Create;True;0;0;0;False;0;False;0;0.103;0;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;640,896;Inherit;False;Property;_Color;Color;34;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;98;1280,896;Inherit;False;Apply Height Fog;0;;1019;950890317d4f36a48a68d150cdab0168;0;1;81;FLOAT3;0,0,0;False;3;FLOAT3;85;FLOAT3;86;FLOAT;87
...
ASEEND*/
//CHKSM=250B66022E5CAC4179EFE7C79CD8D3970D6C6A4B
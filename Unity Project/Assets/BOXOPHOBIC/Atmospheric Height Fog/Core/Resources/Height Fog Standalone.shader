...
Shader "BOXOPHOBIC/Atmospherics/Height Fog Standalone"
{
	Properties
	{
		...
		[NoScaleOffset][StyledTextureSingleLine]_NoiseTexture("Noise Texture", 3D) = "white" {}
		[Space(10)]_NoiseIntensity("Noise Intensity", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_7_0_g1032 = _FogDistanceStart;
				float temp_output_155_0_g1027 = saturate( ( ( distance( WorldPosition2_g1027 , _WorldSpaceCameraPos ) - temp_output_7_0_g1032 ) / ( _FogDistanceEnd - temp_output_7_0_g1032 ) ) );
				...
				float4 ScreenPos3_g1034 = screenPos;
				float2 UV13_g1034 = ( ( (ScreenPos3_g1034).xy / (ScreenPos3_g1034).z ) * (_ScreenParams).xy );
				float3 Magic14_g1034 = float3(0.06711056,0.00583715,52.98292);
				float dotResult16_g1034 = dot( UV13_g1034 , (Magic14_g1034).xy );
				float lerpResult494_g1027 = lerp( 0.0 , frac( ( frac( dotResult16_g1034 ) * (Magic14_g1034).z ) ) , ( _JitterIntensity * 0.1 ));
				...
				float temp_output_7_0_g1029 = _FogHeightEnd;
				float temp_output_167_0_g1027 = saturate( ( ( ( break159_g1027.x + break159_g1027.y + break159_g1027.z ) - temp_output_7_0_g1029 ) / ( _FogHeightStart - temp_output_7_0_g1029 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				...
				float3 temp_output_561_0_g1027 = ( ( ( WorldPosition2_g1027 * ( 1.0 / _NoiseScale ) ) + ( -_NoiseSpeed * mulTime204_g1027 ) ) * 0.05 );
				float temp_output_7_0_g1033 = _NoiseMin;
				float temp_output_7_0_g1031 = _NoiseDistanceEnd;
				half NoiseDistanceMask7_g1027 = saturate( ( ( distance( WorldPosition2_g1027 , _WorldSpaceCameraPos ) - temp_output_7_0_g1031 ) / ( 0.0 - temp_output_7_0_g1031 ) ) );
				float lerpResult198_g1027 = lerp( 1.0 , saturate( ( ( tex3D( _NoiseTexture, temp_output_561_0_g1027 ).r - temp_output_7_0_g1033 ) / ( _NoiseMax - temp_output_7_0_g1033 ) ) ) , ( NoiseDistanceMask7_g1027 * _NoiseIntensity ));
				...
				float temp_output_7_0_g1030 = _SkyboxFogHeight;
				float temp_output_176_0_g1027 = saturate( ( ( abs( temp_output_449_0_g1027 ) - temp_output_7_0_g1030 ) / ( 0.0 - temp_output_7_0_g1030 ) ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;1107;-3136,-4736;Half;False;Property;_HeightFogStandalone;_HeightFogStandalone;40;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1106;-2880,-4736;Half;False;Property;_IsHeightFogShader;_IsHeightFogShader;41;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1134;-3328,-4608;Inherit;False;Base;1;;1027;13c50910e5b86de4097e1181ba121e0e;34,360,1,99,1,388,1,557,1,555,1,550,1,354,1,386,1,345,1,351,1,349,1,368,1,378,1,374,1,370,1,450,1,476,1,384,1,339,1,392,1,355,1,116,1,364,1,361,1,500,1,366,1,382,1,376,1,380,1,372,1,343,1,347,1,597,1,603,1;0;3;FLOAT4;113;FLOAT3;86;FLOAT;87
WireConnection;1121;2;1134;86
WireConnection;1121;3;1134;87
ASEEND*/
//CHKSM=53A9952D80B008C4AF39821A8B2BF31BC9A8A8DA
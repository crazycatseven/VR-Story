...
Shader "UI/Default (Height Fog Support)"
{
    Properties
    {
        ...
        [StyledCategory(Directional Settings, false, _HeightFogStandalon, 10, 10)]_DirectionalCat("[ Directional Cat ]", Float) = 1
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            uniform sampler3D AHF_NoiseTexture;
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float temp_output_155_0_g931 = saturate( ( ( distance( WorldPosition2_g931 , _WorldSpaceCameraPos ) - temp_output_7_0_g1016 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1016 ) ) );
                #ifdef AHF_DISABLE_FALLOFF
                float staticSwitch467_g931 = temp_output_155_0_g931;
                #else
                float staticSwitch467_g931 = ( 1.0 - pow( ( 1.0 - abs( temp_output_155_0_g931 ) ) , AHF_FogDistanceFalloff ) );
                #endif
                half FogDistanceMask12_g931 = staticSwitch467_g931;
                float3 lerpResult258_g931 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( ( FogDistanceMask12_g931 * FogDistanceMask12_g931 * FogDistanceMask12_g931 ) * AHF_FogColorDuo ));
                ...
                half Jitter502_g931 = 0.0;
                float temp_output_140_0_g931 = ( saturate( (( dotResult145_g931 + Jitter502_g931 )*0.5 + 0.5) ) * AHF_DirectionalIntensity );
                #ifdef AHF_DISABLE_FALLOFF
                ...
                #endif
                half3 Input_Color6_g1012 = staticSwitch442_g931;
                ...
                #endif
                half3 Final_Color462_g931 = staticSwitch1_g1012;
                ...
                float temp_output_167_0_g931 = saturate( ( ( ( break159_g931.x + break159_g931.y + break159_g931.z ) - temp_output_7_0_g1013 ) / ( AHF_FogHeightStart - temp_output_7_0_g1013 ) ) );
                #ifdef AHF_DISABLE_FALLOFF
                ...
                float3 temp_output_561_0_g931 = ( ( ( WorldPosition2_g931 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g931 ) ) * 0.05 );
                float temp_output_7_0_g1017 = AHF_NoiseMin;
                float temp_output_7_0_g1015 = AHF_NoiseDistanceEnd;
                half NoiseDistanceMask7_g931 = saturate( ( ( distance( WorldPosition2_g931 , _WorldSpaceCameraPos ) - temp_output_7_0_g1015 ) / ( 0.0 - temp_output_7_0_g1015 ) ) );
                float lerpResult198_g931 = lerp( 1.0 , saturate( ( ( tex3D( AHF_NoiseTexture, temp_output_561_0_g931 ).r - temp_output_7_0_g1017 ) / ( AHF_NoiseMax - temp_output_7_0_g1017 ) ) ) , ( NoiseDistanceMask7_g931 * AHF_NoiseIntensity ));
                ...
                float4 appendResult457_g931 = (float4(WorldPosition2_g931 , 1.0));
...
ASEEND*/
//CHKSM=D823EAEE0F1C977C616FB4E745118EED066F4C67